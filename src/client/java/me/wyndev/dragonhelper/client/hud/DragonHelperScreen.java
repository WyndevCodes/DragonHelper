...
public class DragonHelperScreen extends Screen {
    ...
    private static final ScreenElementGroup[] elements = new ScreenElementGroup[]{
            new ScreenElementGroup(
                    () -> (ServerConfig.instance.currentServerHasFeature(Feature.KILL_TRACKING_COMMAND) && DragonHelperConfig.get().ui.zealotKillCounter),
            ...
            new ScreenElementGroup(
                    () -> (ServerConfig.instance.currentServerHasFeature(Feature.PROTECTOR_NAME_CONTAINS_TEXT) && DragonHelperConfig.get().ui.endstoneProtectorKillCounter),
            ...
            new ScreenElementGroup(
                    () -> (ServerConfig.instance.currentServerHasFeature(Feature.KILL_TRACKING_COMMAND) && DragonHelperConfig.get().ui.dragonKillCounter),
            ...
            new ScreenElementGroup(
                    () -> (ServerConfig.instance.currentServerHasFeature(Feature.PROTECTOR_NAME_CONTAINS_TEXT) && DragonHelperConfig.get().ui.endstoneProtectorTimer),
            ...
            new ScreenElementGroup(
                    () -> (ServerConfig.instance.currentServerHasFeature(Feature.RNG_METER_TRACKING_COMMAND) && DragonHelperConfig.get().ui.rngMeterTracker),
            ...
            new ScreenElementGroup(
                    () -> (ServerConfig.instance.currentServerHasFeature(Feature.SLAYER_EXP_TRACKING_COMMAND) && DragonHelperConfig.get().ui.zombieSlayerLevelTracker),
